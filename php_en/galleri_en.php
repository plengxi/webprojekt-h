...
<div class="headlinecontainer">
  ...
  <h1  class="headline" ><span style="color:#F5CB3C; font-size: 3.438rem; ">G</span>allery</h1>
...
<div href="#" id="visamercontainer">
    ...
    <a type="button" class="visamer" id="first" onclick="show()">Show morer</a>
...
<div href="#" id="visamercontainer" class="second">
  ...
  <a type="button" class="visamer" onclick="hide()">Show less</a>
